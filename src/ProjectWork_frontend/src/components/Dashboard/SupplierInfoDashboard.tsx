...
import SupplierDocsDashboard from "./SupplierDocsDashboard";
import { toast } from "react-toastify";

const SupplierInfoDashboard = ({
  showSupModal,
  setShowSupModal,
  selectedSupplier,
  setSelectedSupplier,
        ...
        <TEModalDialog size="xl">
          <TEModalContent>
            ...
            <TEModalBody className="bg-gray-500">
              ...
              {docsTab && <SupplierDocsDashboard {...{ docs }} />}
...
export default SupplierInfoDashboard;
